      ...
      <div className="container mx-auto flex flex-col md:flex-row p-2 h-full gap-2 mobile-order">
        ...
        <div className="w-full md:w-2/3 flex flex-col items-center space-y-2 sm:space-y-4 mt-1 min-h-0 overflow-y-auto mobile-order-left">
          ...
          <div className="relative flex flex-col items-center justify-center mb-2 sm:mb-6 w-full max-w-xs mx-auto mobile-order-1">
            ...
            <div className="flex items-center justify-center mt-2 w-full gap-2 sm:gap-3 mb-2">
              {/* Nút Mute bên trái */}
              <button
...
@media (max-width: 640px) {
  ...
  #interface2 .container.mobile-order {
    flex: 1 1 0%;
    display: flex;
    flex-direction: column;
    height: 100vh;
  ...
  .mobile-order-1 { flex: 0 0 90px; min-height: 70px; max-height: 100px; }
  .mobile-order-2 { flex: 0 0 48px; min-height: 40px; max-height: 56px; }
  .mobile-order-3 { flex: 0 0 60px; min-height: 40px; max-height: 70px; overflow-y: auto; }
  .mobile-order-4 { flex: 1 1 0%; min-height: 60px; max-height: 120px; overflow-y: auto; }
  .mobile-order-5 { flex: 0 0 80px; min-height: 60px; max-height: 100px; overflow-y: auto; }
  .mobile-order-1, .mobile-order-2, .mobile-order-3, .mobile-order-4, .mobile-order-5 {
    margin-bottom: 4px !important;
  }
  .mobile-order-4 .flex, .mobile-order-4 .flex-row, .mobile-order-4 .flex-col {
    gap: 2px !important;
  }
  .mobile-order-4 span, .mobile-order-4 button, .mobile-order-4 svg {
  ...
  .mobile-order-1 .relative, .mobile-order-1 .flex, .mobile-order-1 .items-center {
    padding: 0 !important;
    margin: 0 !important;
  }
  .mobile-order-2 button, .mobile-order-2 .Button {
